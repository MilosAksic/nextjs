...
})(["display:", ";flex-direction:", ";@media (max-width:600px){width:", ";}@media only screen and (max-width:960px) and (min-width:601px){width:", ";}@media only screen and (max-width:1280px) and (min-width:961px){width:", ";}@media only screen and (max-width:1920px) and (min-width:1281px){width:", ";}@media (min-width:1921px){width:", ";}"], function (props) {
...
})(["background:", ";color:", ";font-size:1em;margin:1em;padding:0.25em 1em;border:2px solid palevioletred;border-radius:3px;"], function (props) {
...
//# sourceMappingURL=index.js.9e5c7e579d1e230ca30b.hot-update.js.map